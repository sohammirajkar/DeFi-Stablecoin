...
contract DSCEngine is ReentrancyGuard {
     ...
     * @param amountCollateral the amout of the collateral to redeem
     ...
     * @param user The user who has broken their healthfactor. Their _healthfactor should be below MIN_HEALTH_FACTOR
     * @param debtToCover The amount of Dsc wants burn to improve users healthfactor
     * @notice you can partially liquidate a user
     * @notice you will get a liquidation bonus for taking users funds
     * @notice This function working assumes protocol will be roughly 200% overcollateralized
     * @notice A known bug would be if the protocol were 100% or less collateralized, then we would not be able to incentivize liquidators.
